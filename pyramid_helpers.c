 ...
 * 
 * Parameters:
 *       board  -  Array of integers assumed to be size of 15.
 * 
 */
...
void pyramid_print(const int board[]) {
    ...
    for (line = 0; line < 5; line++) {
         ...
         * output for this line of the pyramid game.  Each "peg box" takes
 ...
 *
 * Error Trap  -  If i/o error, prints message and exits program.
 */
...
/* 
 * pyramid_input:  Allows the user to input a starting position for
 *                  the pyramid game.
 *
 * Parameters:
 *       board  -  Array of integers assumed to be size of 15.
 * 
 * Completion:     board[] will contain the resultant board on completion.
 */
